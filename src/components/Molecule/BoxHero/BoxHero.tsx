...
export const BoxHero = () => {
  return (
    <div className="flex flex-col items-center gap-4 bg-gradient-to-b from-gray-500 to-dark-blue px-5 py-8 d-1:px-10 d-1:py-12 rounded-md max-w-[22rem] d-1:max-w-[30rem] u-1:max-w-[35rem]">
      <div>
        <h1 className="font-bold text-white text-center text-lg d-0:text-xl d-1:text-3xl u-1:text-4xl">
          ESTAR NA INTERNET <br/>NÃO É O SUFICIENTE
        </h1>
      </div>
      <div className="flex flex-col gap-4">
        <p className="text-white text-sm font-medium d-0.02:text-base u-1:text-lg">
